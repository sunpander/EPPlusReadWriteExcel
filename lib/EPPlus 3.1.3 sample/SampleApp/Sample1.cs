	...
	public class Sample1
	{
		...
		public static string RunSample1(DirectoryInfo outputDir)
		{
			...
			using (ExcelPackage package = new ExcelPackage(newFile))
            {
                ...
                worksheet.Cells["B3"].Value = "Hamme5t5t5t6yyyyyyyyyr";
                ...
                package.Workbook.Properties.Author = "Jan Klman";
                ...
                package.Workbook.Properties.SetCustomPropertyValue("Checked by", "Jan Klman");
